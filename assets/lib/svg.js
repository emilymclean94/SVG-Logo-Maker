class SVG {
    ...
    So we need to do some research on how to create an SVG file!!

    We need to create a render method that returns a string that represents an SVG file with our passed elements.
